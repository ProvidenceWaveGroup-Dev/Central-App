...
export default function ReportsPage() {
  ...
  const allRows = useMemo(() => {
    ...
    add("overview", "Overview", "Noted Conditions", String(assigned?.chronic_conditions || "Not provided"), "", "assigned-patient-api", "Noted conditions on file.");
  ...
  const downloadPdf = async () => {
    ...
    try {
      ...
      doc.save(`betti-report-${new Date().toISOString().slice(0, 10)}.pdf`);
    } catch (e) {
