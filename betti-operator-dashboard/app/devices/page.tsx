...
const devices: Device[] = [
  { id: "DEV-001", type: "Motion Sensor", location: "Room 105", status: "online", battery: 92, signal: "Strong", lastPing: "1 min ago" },
  { id: "DEV-002", type: "Vitals Monitor", location: "Room 118", status: "online", battery: 85, signal: "Strong", lastPing: "30 sec ago" },
  { id: "DEV-003", type: "Emergency Button", location: "Room 204", status: "online", battery: 78, signal: "Good", lastPing: "2 min ago" },
  { id: "DEV-004", type: "Door Sensor", location: "Room 205", status: "offline", battery: 0, signal: "None", lastPing: "22 min ago" },
  { id: "DEV-005", type: "Motion Sensor", location: "Room 220", status: "online", battery: 18, signal: "Good", lastPing: "1 min ago" },
  { id: "DEV-006", type: "Vitals Monitor", location: "Room 302", status: "online", battery: 95, signal: "Strong", lastPing: "15 sec ago" },
  { id: "DEV-007", type: "Emergency Button", location: "Room 310", status: "online", battery: 12, signal: "Weak", lastPing: "5 min ago" },
  { id: "DEV-008", type: "Door Sensor", location: "Room 401", status: "online", battery: 67, signal: "Good", lastPing: "3 min ago" },
  { id: "DEV-009", type: "Motion Sensor", location: "Room 408", status: "online", battery: 22, signal: "Good", lastPing: "2 min ago" },
  { id: "DEV-010", type: "Vitals Monitor", location: "Room 115", status: "online", battery: 88, signal: "Strong", lastPing: "45 sec ago" },
];
    ...
    <div className="p-4 md:p-6 lg:p-8">
      <div className="mx-auto max-w-7xl space-y-6">
        ...
        <div className="rounded-xl border border-gray-200 bg-white overflow-hidden">
          <div className="hidden lg:grid grid-cols-7 gap-4 px-5 py-3 bg-gray-50 border-b border-gray-200 text-xs font-semibold text-gray-500 uppercase tracking-wider">
            <div>Device ID</div>
            <div>Type</div>
            <div>Location</div>
            <div>Status</div>
          ...
          {devices.map((d) => {
            ...
            return (
              <div key={d.id} className="grid grid-cols-1 lg:grid-cols-7 gap-2 lg:gap-4 items-center px-5 py-4 border-b border-gray-100 hover:bg-gray-50 transition-colors">
                ...
                <div>
                  <div className="flex items-center gap-2">
                    <div className="flex-1 h-2 rounded-full bg-gray-200 max-w-20">
                      <div className={`h-2 rounded-full ${batteryColor(d.battery)}`} style={{ width: `${d.battery}%` }} />
                    </div>
